...
export const meta = {
  ...
  lastEdited: '2020-01-27T20:34:48.000Z'
}
...
All other logs are stored in memory only and are **not persisted** between page views. Each log output is **limited to 4kb**. For log outputs greater than 4kb, only the last 4kb will be retained.
