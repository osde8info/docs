...
export const meta = {
  ...
  lastEdited: '2020-01-29T22:17:40.000Z'
}
...
If you need persistent connections to push data to the client, see the [Pusher Channels Guide](https://zeit.co/guides/deploying-pusher-channels-with-zeit-now).
